...
<div id="content">
  ...
  <div class="container-fluid">
    <hr>
    <a type="submit" href="{{ url('/add_user') }}" class="btn btn-success" /> Add User</a>
    <div class="row-fluid">
      <div class="span12">
             ...
             <tbody>
              @foreach($user as $us)
               ...
               <tr class="gradeX">
                  <td>{{ $a++ }}</td>
                  <td>{{ $us->nama }}</td>
                  <td>{{ $us->jabatanUser->jabatan }}</td>
                  <td>{{ $us->email }}</td>
                  <td>{{ $us->no_telepon }}</td>
                  <td class="center"><a href="{{url ('/edit_user/'.$us->id) }}" class="btn btn-primary btn-mini">Edit</a>  <a href="{{url ('/delete_user/'.$us->id) }}" class="deletebtn btn btn-danger btn-mini">Delete</a></td>
                </tr>
