          ...
          <div class="widget-content nopadding">
            <form action="#" method="POST" class="form-horizontal" name="form_schedule" id="form_schedule">
                ...
                <div class="controls">
                  <select name="dokter">
                    @foreach($dokter as $dok)
                      <option value="{{ $dok->id }}" 
                        @if($dok->id == $jadwal->id_dokter) 
                          @php 
                          echo "selected";
                          @endphp
                        @endif >{{ $dok->nama }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="date" class="span11" name="from_date" id="from_date" value="{{ $jadwal->tanggal_mulai }}"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Until Date :</label>
                <div class="controls">
                  <input type="date" class="span11" name="until_date" id="until_date" value="{{ $jadwal->tanggal_akhir }}"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">From Time :</label>
                <div class="controls">
                  <input type="time" class="span11" name="from_time" id="from_time" value="{{ $jadwal->waktu_mulai }}"/>
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Until Time :</label>
                <div class="controls">
                  <input type="time" class="span11" name="until_time" id="until_time" value="{{ $jadwal->waktu_akhir }}"/>
                </div>
              </div>
