...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Room History</a> </div>
    <h1>Room History</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>List of Room History (format tanggal: Tahun-bulan-tanggal)</h5>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
             ...
             <tbody>
                @foreach($histori_ruangan as $hisruang)
               <tr class="gradeX">
                  <td>{{ $a++ }}</td>
                  <td>{{ $hisruang->keteranganRuangan->nama }}</td>
                  <td>{{ $hisruang->keteranganUser->nama }}</td>
                  <td>{{ $hisruang->status }}</td>
                  <td>{{ $hisruang->waktu }}</td>
                </tr>
              @endforeach  
             </tbody>
            </table>
