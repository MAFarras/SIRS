...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Doctor</a> <a href="#" class="current">Add Doctor</a> </div>
    <h1>Add Doctor</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="#" name="form_doctor" id="form_doctor" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" name="doctor_name" id="doctor_name">
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  @foreach($specialization as $spec)
                      <option value="{{ $spec->id }}">{{ $spec->nama }}</option>
                  @endforeach
                  </select>
                </div>
              </div>
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" name="doctor_phone_number" id="doctor_phone_number">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Practical Number</label>
                <div class="controls">
                  <input type="text" class="span11" name="practical_number" id="practical_number">
                </div>
              </div>
