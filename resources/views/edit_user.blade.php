...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">User</a> <a href="#" class="current">Edit User</a> </div>
    <h1>Form of User</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form action="{{ url('/edit_user/'.$user->id) }}" method="POST" class="form-horizontal" name="edit_user" id="edit_user" novalidate="novalidate">
              @csrf
              <div class="control-group">
                ...
                <div class="controls">
                  ...
                  @foreach($role as $rol)
                    @if($rol->id != 1 ){
                      <option value="{{ $rol->id }}"
                        @if($rol->id == $user->id_jabatan) 
                          @php 
                          echo "selected";
                          @endphp
                        @endif>{{ $rol->jabatan }}</option>
                    }
                    @endif
                  @endforeach
                  </select>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" placeholder="Enter Name" name="user_name" id="user_name" value="{{ $user->nama }}" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Email :</label>
                <div class="controls">
                  <input type="text" class="span11" placeholder="Enter Email" name="user_email" id="user_email" value="{{ $user->email }}" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Telephone :</label>
                <div class="controls">
                  <input type="text" class="span11" placeholder="Enter Phone Number" name="no_telp" id="no_telp" value="{{ $user->no_telepon }}" />
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Password :</label>
                <div class="controls">
                  <input type="password" class="span11" placeholder="Enter Password if You Want to Change it"  name="user_pwd"/>
                </div>
              </div>
