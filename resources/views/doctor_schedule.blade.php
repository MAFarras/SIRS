...
<div id="content">
  ...
  <div class="container-fluid">
    <hr>
    <a type="submit" href="{{ url('/add_schedule') }}" class="btn btn-success"/>Add Schedule</a>
    <div class="row-fluid">
      <div class="span12">
            ...
            <table class="table table-bordered data-table">
             ...
             <tbody>
               ...
               <tr class="gradeX">
                  ...
                  <td class="center">
                    <a href="{{url ('/edit_schedule/'.$jad->id) }}" class="btn btn-primary btn-mini">Edit</a>  
                    <a href="{{url ('/delete_schedule/'.$jad->id) }}" class="deletebtn btn btn-danger btn-mini">Delete</a>
                  </td>
                </tr>
              @endforeach
             </tbody>
