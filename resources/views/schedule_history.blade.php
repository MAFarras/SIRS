...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Schedule History</a> </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"><i class="icon-th"></i></span>
            <h5>List of Schedule History (format tanggal: Tahun-bulan-tanggal)</h5>
          </div>
          <div class="widget-content nopadding">
            <table class="table table-bordered data-table">
             ...
             <tbody>
               @foreach($histori_jadwal as $hisjad)
               <tr class="gradeX">
                  <td>{{ $a++ }}</td>
                  <td>{{ $hisjad->keteranganUser->nama }}</td>
                  <td>{{ $hisjad->keteranganDokter->nama }}</td>
                  <td>{{ $hisjad->tanggal_mulai}}</td>
                  <td>{{ $hisjad->tanggal_akhir}}</td>
                  <td>{{ $hisjad->waktu_mulai}}</td>
                  <td>{{ $hisjad->waktu_akhir}}</td>
                  <td>{{ $hisjad->tanggal_waktu_buat }}</td>
                </tr>
              @endforeach               
             </tbody>
            </table>
