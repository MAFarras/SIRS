...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Doctor</a> </div>
    <h1>Doctor</h1>
  ...
  <div class="container-fluid">
    <hr>
    <a type="submit" href="{{ url('/add_doctor') }}" class="btn btn-success" /> Add Doctor</a>
    <div class="row-fluid">
      <div class="span12">
             ...
             <tbody>
              @foreach($doctor as $doc)
               <tr class="gradeX">
                  <td>{{ $a++ }}</td>
                  <td>{{ $doc->nama }}</td>
                  <td>{{ $doc->jenisDokter->nama }}</td>
                  <td>{{ $doc->no_praktek }}</td>
                  <td>{{ $doc->no_telp }}</td>
                  <td class="center"><a href="{{url ('/edit_doctor/'.$doc->id) }}" class="btn btn-primary btn-mini">Edit</a>  <a href="{{url ('/delete_doctor/'.$doc->id) }}" class="deletebtn btn btn-danger btn-mini">Delete</a></td>
                </tr>
              @endforeach   
             </tbody>
            </table>
