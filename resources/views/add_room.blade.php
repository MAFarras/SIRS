...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#">Room Status</a> <a href="#" class="current">Add Room</a> </div>
    <h1>Add Room</h1>
  </div>
          ...
          <div class="widget-content nopadding">
            <form action="#" method="POST" class="form-horizontal" name="form_room" id="form_room" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="span11" name="room_name" id="room_name"/>
                </div>
              </div>
                ...
                <div class="controls">
                  <select name="room_type">
                    ...
                    @foreach($jenis_ruangan as $jenru)
                      <option value="{{ $jenru->id }}">{{ $jenru->nama }}</option>
                    @endforeach
                  </select>
                </div>
              </div>
