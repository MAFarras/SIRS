...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li ><a title="" href="{{ url('/edit_profile') }}"><i class="icon icon-cog"></i> <span class="text">Settings</span></a></li>
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="{{ url('/edit_profile') }}" class="current">Profile</a> </div>
    <h1>Profile</h1>
  </div>
      ...
      <div class="span12">
        <div class="widget-box">
          <div class="widget-title"> <span class="icon"> <i class="icon-info-sign"></i> </span>
            <h5>Form of Profile</h5>
          </div>
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="POST" action="#" name="form_profile" id="form_profile" novalidate="novalidate">
            @csrf
              <div class="control-group">
                <label class="control-label">Nama</label>
                <div class="controls">
                  <input type="text" name="user_name" id="user_name" placeholder="Enter Name" value="{{ Auth::user()->nama }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Telephone Number</label>
                <div class="controls">
                  <input type="text" name="no_telp" id="no_telp" placeholder="Enter Telephone Number" value="{{ Auth::user()->no_telepon }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Email</label>
                <div class="controls">
                  <input type="text" name="user_email" id="user_email" placeholder="Enter Email" value="{{ Auth::user()->email }}">
                </div>
              </div>
              <div class="control-group">
                <label class="control-label">Pasword</label>
                <div class="controls">
                  <input type="text" name="user_pwd" placeholder="Enter Password if You want to change your password">
                </div>
              </div>
