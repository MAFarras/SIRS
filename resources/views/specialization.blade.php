...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a> <a href="#" class="current">Specialization</a> </div>
  ...
  <div class="container-fluid">
    <hr>
    <a type="submit" href="{{ url('/add_specialization') }}" class="btn btn-success" /> Add Specialization</a>
    <div class="row-fluid">
      <div class="span12">
            ...
            <table class="table table-bordered data-table">
             ...
             <tbody>
               ...
               <tr class="gradeX">
                  ...
                  <td class="center"><a href="{{url ('/edit_specialization/'.$fil->id) }}" class="btn btn-primary btn-mini">Edit</a>  <a href="{{url ('/delete_specialization/'.$fil->id) }}" class="deletebtn btn btn-danger btn-mini">Delete</a></td>
                </tr>
              @endforeach  
             </tbody>
            </table>
